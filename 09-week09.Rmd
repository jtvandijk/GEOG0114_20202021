...
<blockquote class="twitter-tweet"><p lang="en" dir="ltr">Following a coding tutorial<a href="https://t.co/dXUfp0WWv7">pic.twitter.com/dXUfp0WWv7</a></p>&mdash; Tawanda Nyahuye👨
...
- Load MSOA file, simplify, map clustering results

### Assignment {#assignment_w09_2}

- Data automation: You could automate the script in R to produce a table of means and a map each time you change the number of clusters this would allow you to compare the outputs more details and see the impact of changing the number of clusters or variables.
