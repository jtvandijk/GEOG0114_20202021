...
```{r 09-post-process-some-cluster-stuff, warnings=FALSE, message=FALSE}
...
- takes three input variables: **a data frame that contains your input data**, **the number of clusters that you want**, and **a list of input variables**, i.e. `automate_k_means(dataframe,number_of_clusters,input_variables)`
...
- Inclue doptional arguments in your function with **default values** if not specified.
